      ...
      >
        ...
        <div
          className={cn(
            ...
            "w-[--sidebar-width] group-data-[collapsible=icon]:w-[--sidebar-width-icon]", // Simplified width logic
        ...
        <div
          className={cn(
            ...
            "w-[--sidebar-width] group-data-[state=collapsed]:w-[--sidebar-width-icon]", // Handle collapsed width
            className
          )}
          {...props}
        >
    ...
    if (!tooltip) {
      tooltip =
        typeof children === "string"
          ? { children }
          : { children: (children as React.ReactElement)?.props?.children?.[1]?.props?.children };
    }
