...
const recentAlerts: Alert[] = [
  ...
  { id: 'AL-9871', timestamp: '2023-10-26 20:05:33', severity: 'Critical', description: 'Data exfiltration pattern identified from patient records DB', ttp_id: 'T1048', status: 'New', source: 'DLP', entity: 'DB-PATIENT-RECORDS' },
];
